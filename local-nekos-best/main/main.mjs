 ...
 * });
 */
export function callNekoIntent(options = {}) {
  if (intentLocked) {
    throw new Error(
 ...
 * console.log(actions);
 */
export function callNekoActions() {
  if (intentConfig.active) {
    return Array.from(intentConfig.allowedCategories);
  }
  return [...VALID_ACTIONS];
 ...
 */
export function callNeko(options = {}) {
